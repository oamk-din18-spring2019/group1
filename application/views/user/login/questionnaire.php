      ...
      <form class="text-left" method="POST" action="chooseCategories">
        <?php
          for ($i = 1; $i < count($categories); $i++) 
          {
            ...
            echo '<input name="' . $categories[$i] . '" id="customCheck' . $i . '" class="checkbox custom-control-input" type="checkbox" value=1>';
        ...
        ?>
        <input type="submit" class="btn btn-success" id="BoxSelect" value="Submit" disabled>

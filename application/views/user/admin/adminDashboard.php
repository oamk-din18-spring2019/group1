                    ...
                    for ($i=0; $i<count($allNews); $i++)
                    {
                        echo '<div class="card mt-2 rounded-0">';
                            echo '<div class="card-header ">';
                                echo '<h5 class="font-weight-bold card-title mb-0 float-left">'.$allNews[$i]['title'].'</h5>';
                                echo '<a class="float-right mx-2" href="'.site_url("user/deleteNews/").$allNews[$i]['id'].'"> <i class="fas fa-times"></i></a>';
                            echo '</div>';

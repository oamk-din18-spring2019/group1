...
class User extends CI_Controller
{
  ...
  function access_denied(){  //this prevents unauthorized access
  ...
  function profile() { //open the profile of current logged in user
    $this -> load -> view ('user/profile/headerProfile');
    $this -> load -> view('user/profile/profile');
    $this -> load -> view ('user/profile/footerProfile');
  }

  function others_profile() { //open profiles of other users (when not logged in)
    $this -> load -> view ('user/profile/headerProfile');
